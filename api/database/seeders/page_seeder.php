    ...
    public function run()
    {
        ...
        $pages = [
            [
                ...
                'meta'    => ['keywords' => 'about, ecommerce, vastcommerce, company, mission', 'description' => 'Learn about VastCommerce — our story, mission, and the team behind the platform.'],
            ],
            [
                'title'   => 'Contact Us',
                'name'    => 'Contact',
                ...
                'meta'    => ['keywords' => 'contact, support, email, help', 'description' => 'Contact the VastCommerce team for support, sales, or partnership enquiries.'],
            ],
            [
                ...
                'meta'    => ['keywords' => 'faq, questions, help, orders, returns', 'description' => 'Find answers to the most commonly asked questions about shopping on VastCommerce.'],
            ],
            [
                ...
                'meta'    => ['keywords' => 'terms, conditions, legal, agreement', 'description' => 'Read the Terms and Conditions governing your use of the VastCommerce platform.'],
            ],
            [
                ...
                'meta'    => ['keywords' => 'privacy, data, GDPR, policy, security', 'description' => 'Our commitment to protecting your personal data and privacy.'],
            ],
            [
                ...
                'meta'    => ['keywords' => 'shipping, returns, delivery, policy, refund', 'description' => 'Information about our shipping options, delivery times, and returns process.'],
            ],
            [
                'title'   => 'Refund Policy',
                'name'    => 'Refund Policy',
                ...
                'meta'    => ['keywords' => 'refund, money back, return, policy', 'description' => 'Our hassle-free refund policy — your satisfaction is guaranteed.'],
            ],
            [
                'title'   => 'Cookie Policy',
                'name'    => 'Cookie Policy',
                ...
                'meta'    => ['keywords' => 'cookie, gdpr, tracking, analytics, consent', 'description' => 'How we use cookies on VastCommerce and how you can manage your preferences.'],
            ],
        ];
        ...
        foreach ($pages as $p) {
            ...
            $stmt->execute([$p['slug']]);
            if ($stmt->fetch()) {
                echo "⚠️  Page '{$p['title']}' already exists\n";
                continue;
            }

            $stmt = $this->pdo->prepare('
                INSERT INTO pages (title, name, slug, content, banner_image, meta_info, is_active, created_at, updated_at)
                VALUES (?, ?, ?, ?, ?, ?, 1, NOW(), NOW())
            ');
