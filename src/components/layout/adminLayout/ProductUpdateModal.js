      ...
      <ui-modal id="product-edit-modal" position="right" size="lg" close-on-backdrop-click="false">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4">
              ...
              <div class="sm:col-span-2">
                <div class="p-4 rounded-2xl border border-slate-100 bg-white shadow-sm">
                  <div class="flex items-start justify-between gap-4 mb-4">
                    ...
                    <ui-switch id="edit-has-brand" checked onchange="this.closest('app-products-page').toggleBrandSection('edit')">
              ...
              <div class="sm:col-span-2">
                <div class="p-4 rounded-2xl border border-slate-100 bg-white shadow-sm">
                  <div class="flex items-start justify-between gap-4 mb-4">
                    ...
                    <ui-switch id="edit-has-material" checked onchange="this.closest('app-products-page').toggleMaterialSection('edit')">
                      <span slot="label">Enable</span>
                    </ui-switch>
                  </div>
            ...
            <!-- 7a. Variations -->
            <div id="edit-variant-section" class="pt-2 border-t border-slate-100">
              <div class="p-4 rounded-2xl border border-slate-100 bg-white shadow-sm">
                <div class="flex items-start justify-between gap-4 mb-4">
                  <div>
                  ...
                  <ui-switch id="edit-has-variants" checked onchange="this.closest('app-products-page').toggleVariantSection('edit')">
                    <span slot="label">Enable</span>
                  </ui-switch>
                </div>
            ...
            <!-- 7b. Attributes -->
            <div id="edit-attribute-section" class="pt-2 border-t border-slate-100">
              <div class="p-4 rounded-2xl border border-slate-100 bg-white shadow-sm">
                <div class="flex items-start justify-between gap-4 mb-4">
                  <div>
                  ...
                  <ui-switch id="edit-has-attributes" checked onchange="this.closest('app-products-page').toggleAttributeSection('edit')">
                    <span slot="label">Enable</span>
                  </ui-switch>
                </div>
                <div id="edit-attribute-body" class="space-y-3 overflow-hidden transition-all duration-300" style="max-height: 1000px; opacity: 1;">
                  <div id="attribute-list" class="space-y-3"></div>
                </div>
                <div id="edit-attribute-actions" class="flex justify-end mt-3 transition-opacity duration-200">
