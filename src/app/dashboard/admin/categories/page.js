    ...
    return `
      <div class="p-10 pb-20">
        <header class="flex items-center justify-between mb-12">
          <div>
            <h1 class="text-4xl font-black text-slate-900 tracking-tighter mb-2 font-brand">Collections</h1>
            <p class="text-slate-500 font-medium">Organize your products into categories.</p>
          </div>
        ...
        <div class="bg-white border border-slate-100 rounded-[2rem] p-12 text-center shadow-sm">
          ...
          <h3 class="text-xl font-bold text-slate-900 mb-2">No Categories</h3>
          <p class="text-slate-500 max-w-xs mx-auto mb-8">Group your products together for easier browsing.</p>
        </div>
      </div>
    `;
  }
