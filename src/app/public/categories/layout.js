...
class PublicCategoriesLayout extends App {
  constructor() {
    super();
...
customElements.define("app-public-categories-layout", PublicCategoriesLayout);
export default PublicCategoriesLayout;
